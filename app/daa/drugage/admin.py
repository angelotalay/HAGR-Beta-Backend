...
class DrugAgeResultsAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'compound_id', 'species', 'strain',"dosage","age_at_initiation" , 'avg_lifespan_change_percent', "avg_lifespan_p_value" , 'max_lifespan_change_percent', "max_lifespan_p_value",'gender','pubmed_id','notes','last_modified')
